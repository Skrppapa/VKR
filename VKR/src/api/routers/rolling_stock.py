...
from src.schemas.rolling_stocks import RollingStockCreate, RollingStockResponse
from src.services.rolling_stock import RollingStockService
from src.schemas.rolling_stocks import RollingStockUpdate


# Создаем роутер с префиксом и тегом для Swagger
...
async def create_rolling_stock(
    ...
    session: AsyncSession = Depends(get_db_session) # DI в действии!
):
