...
BASE_DIR = Path(__file__).resolve().parent.parent # Определяем корневую директорию (на 2 уровня выше, чем env.py)
...
config.set_main_option("sqlalchemy.url", f"{settings.db_url}?async_fallback=True")  # Миграция - синхронныый процесс. То что в f строке говорит асинхронному движку работать в синхронном режиме
